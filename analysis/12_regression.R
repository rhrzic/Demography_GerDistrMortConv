...
supp_p9 = ggplot(map.independent_vars)+
...
ggsave("figures/supp_p9.png", supp_p9, width = 190, height = 250, unit = 'mm')
rm(supp_7)
...
ggsave("figures/supp_p10.png", supp_8, width = 250, height = 210, unit = 'mm')
